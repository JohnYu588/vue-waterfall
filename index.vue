...
export default {
  ...
  methods: {
      ...
      try {
        const list = [
          ...
          },
          {
            ...
            sign: '但使龙城飞将在，不教胡马度阴山',
          },
          {
            id: 5,
            cover:
              'https://imgm.gmw.cn/attachement/jpg/site215/20201007/5917432693463665344.jpg',
            sign: '胡司令,看在党国的份上,拉兄弟一把~ --- 《鬼吹灯》',
          },
          {
            id: 6,
            cover:
          ...
          },
          {
            id: 8,
            cover:
              'https://imgm.gmw.cn/attachement/jpg/site215/20201007/7334281492777553585.jpg',
            sign: '千磨万击还坚劲，任尔东南西北风',
          },
          {
            id: 9,
            cover:
        ...
        if (list.length > 0) {
          ...
          //   if (list.length > 0) {
          //     const tempIndex = parseInt(Math.random() * 1000) % list.length;
    ...
    resolveDataList(list) {
      ...
      this.isLoading = true; // 下拉刷新请求完成
      this.loading = true; // 上拉加载更多请求完成
